 ...
 * @param tenant
 */
export function conversationsPathForUserId(userId: string): string {
   ...
   */
  export function conversationMessagesRef(userId: string): string {
   ...
   */
  export function contactsRef(): string {
    const urlNodeContacts = "contacts/";
    return urlNodeContacts;
  }

  export function contactsUserRef(userId: string): string {
    const urlNodeContacts = `contacts/${userId}`;
    return urlNodeContacts;
  }

  export function userGroupAttrRef( userId: string, groupId: string) {
  ...
  export function lastOnlineDbRef (userId: string): string {
   ...
   * @param tenant
   */
  export function nodeTypingsPath(conversationWith: string): string {
  ...
  export function setHeaderDate_old(translate, timestamp, lastDate?): string {
    ...
    let labelDays: string = LABEL_TODAY;
  ...
  export function searchEmailOrUrlInString(item: string) {
    item = item.toString();
